      ...
      <div>
        <div className=" font-sansita">
            ...
            <div className="px-3 py-3 lg:px-5 lg:pl-3">
              <div className="flex items-center">
                ...
                <div className="flex items-center justify-center w-full">
                  ...
                  <h1 className="text-4xl text-black text-center w-full">
                    Dashboard
                  </h1>
                </div>
              </div>
          ...
          <div className="flex overflow-hidden">
            ...
            <div
              className="bg-gray-100 opacity-50 hidden fixed inset-0 z-10"
              id="sidebarBackdrop"
            ></div>
            <div
              id="main-content"
              className="h-full w-full relative overflow-y-auto lg:ml-64 bg-white text-black"
            >
              <main className="min-h-[80vh]">
                <div className=" pt-20 px-4">{children}</div>
              </main>
              <footer className="bg-gray-100 md:flex md:items-center md:justify-between shadow rounded-lg p-4 md:p-6 xl:p-8 my-6 mx-4">
