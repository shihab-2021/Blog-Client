...
const Category2 = ({ categories = [] }) => {
  ...
  return (
    <div className="bg-gradient-to-b from-purple-50 to-purple-100 py-16 px-4 sm:px-6 lg:px-8 font-sansita">
        ...
        <div className="flex flex-row flex-wrap gap-6 justify-between">
          {categories?.map((cat, i) => (
            <Link
              ...
              className={`flex-1 min-w-[250px] flex flex-col p-5 bg-gray-50 border border-indigo-100 rounded-lg hover:bg-yellow-200 hover:shadow-lg hover:-translate-y-1 transition-all duration-300 animate-slideFadeIn cursor-pointer`}
